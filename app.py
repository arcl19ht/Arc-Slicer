...
def pack_template_from_form(data: dict, source_id: str) -> PackTemplate:
    ...
    return PackTemplate(
        ...
        description=str(data.get("pack_description") or defaults["pack_description"]).strip(),
        img=img,
...
class SonglistPanel(QFrame):
    ...
    def _setup_ui(self):
        ...
        pack_fields = [
            ...
            ("曲包描述 DESCRIPTION", "pack_description", "Practice clips generated by Arc Slicer."),
    ...
    def get_form_data(self) -> dict:
        ...
        data["pack_description"] = data.get("pack_description") or "Practice clips generated by Arc Slicer."
